...
<div class="container py-5">
    <div class="row">
        <div class="col-12">
            ...
            <p class="mb-2 family-Nunito-sans mt-lg-0 font-16">Let us help make your dream construction needs into a
        ...
        <div class="col-12 mb-4">
                ...
                <div class="col-lg-6 col-sm-5 col-12 pe-lg-0 rounded-0 border-0">
                    <a href="{{ route('web.projects.single',['slug' => $project->slug])}}">
                        <img src="{{ sizeof($project->images) > 0 ? asset($project->images[0]->src) : asset('/images/projects/dummy.jpg') }}"
                            class="card-img-top rounded-0 border-0" alt="...">
                    </a>
                </div>
                    ...
                    <div class="card rounded-0 border-0">
                        <div class="card-body px-lg-5 px-3 py-sm-0">
                            <h3 class="family-Nunito-sans fw-bolder light-black pb-3">
                                {{$project->title}}</h3>
                            <div class="mb-2 family-Nunito-sans mt-lg-0 pb-4 font-16">
                                {!!substr($project->description,0,300)!!} ...</div>
            ...
            <div class="row  mb-4 pb-sm-4">
                <div class="col-lg-6 col-sm-5 col-12 pe-lg-0 rounded-0 border-0 d-lg-none d-block">
                    <a href="{{ route('web.projects.single',['slug' => $project->slug])}}"><img
                            src="{{ sizeof($project->images) > 0 ? asset($project->images[0]->src) : asset('/images/projects/dummy.jpg') }}"
                ...
                <div class="col-lg-6 col-12 pe-lg-0 rounded-0 border-0 d-lg-block d-none">
                    <a href="{{ route('web.projects.single',['slug' => $project->slug])}}"><img src="{{ sizeof($project->images) > 0 ? asset($project->images[0]->src) : asset('/images/projects/dummy.jpg') }}"
                        class="card-img-top rounded-0 border-0" alt="..."></a>
                </div>
            </div>
