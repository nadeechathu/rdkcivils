...
<body style="background-image: url('{{ asset('images/clientPortalBg.jpg') }}'); background-size: cover;">
    ...
    <div class="d-flex flex-column w-100 align-items-center">
      ...
      <a href="{{ url('/') }}" class="d-table mt-5 mb-4 mx-auto">
                <div class="d-flex align-items-center">
                    ...
                    <img class="mx-auto w-50" src="{{ asset($commonContent['siteLogo']['description']) }}" alt="RDK Civil Engineering Limited">
                </div>
            </a>
      <!-- Logo-->
      ...
      <div class="shadow-lg rounded p-4  bg-white form">
        ...
        <div class="row">
          ...
          <div class="col-md-6" style="border-left:1px solid #ececec; border-right:1px solid #ececec;">
              ...
              <button type="submit" style="margin-top:50px !important;" class="btn btn-dark d-block w-100 my-4">Sign Up</button>
