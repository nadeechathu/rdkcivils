...
<div class="card">
  <div class="container">
    ...
    <h3>{{$details['introduction']}}</h3>
        ...
        <p><b>We would like to confirm that your account has been approved.</b> You may now use the registered credentials to login the Client Portal using the following link</p>

        <hr>

        <p>Registered Email - {{$details['email']}}</p>
