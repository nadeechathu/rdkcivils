              ...
              <div class="card-header">
               ...
               <div class="col-md-6">
                @if (Auth::user()->hasPermission('add_posts'))
                 <a href="{{route('posts.new')}}"><button type="button" class="btn btn-primary btn-sm"><i class="ri-add-circle-line align-bottom"></i> Add New Resource</button></a>
               ...
               <div class="col-md-6" style="float:right;">
                <form action="{{route('events.all')}}" method="get">
                        <div class="input-group">
                            <input type="search" class="form-control" name="searchKey" placeholder="Resource Title" value="{{$searchKey}}">
                  ...
                  <tbody>
                   @foreach ($posts as $post)
                       <tr>
                           ...
                           {{-- <td>
                            @if($post->type == 0)
                            <span class="badge bg-success">Resource Content</span>
                            @else
