...
<i class="ri-add-circle-line align-bottom"></i> New Property Part Items
</button>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">New Property Part Items</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{route('property.parts.item.store')}}" method="post" enctype="multipart/form-data">
                @csrf
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Property Part Item Name *</label>
                    <input type="text" name="part_item_name"  class="form-control @error('title') is-invalid @enderror"  placeholder="Part Name Items" value="{{ old('part_item_name') }}" id="" required>
                </div>
                <div class="form-group">
