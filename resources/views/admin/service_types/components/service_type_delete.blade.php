...
<div class="modal fade" id="{{'delete-modal-'.$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            Are you sure you want to delete this service type ? <br/><br/>
        </div>
        <div class="modal-footer">
        <a href="{{route('service_types.remove',$data->id)}}"><button type="button" class="btn btn-primary">Yes</button></a>
