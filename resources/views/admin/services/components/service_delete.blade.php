...
<div class="modal fade" id="{{'delete-modal-'.$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            ...
            <p class="text-danger">All the commments, replies related to this service will be deleted.</p>
        </div>
        <div class="modal-footer">
             <a href="{{route('service.destroy',$data->id)}}"><button type="button" class="btn btn-primary">Yes</button></a>
